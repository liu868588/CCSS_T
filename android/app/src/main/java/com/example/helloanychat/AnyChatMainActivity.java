...
public class AnyChatMainActivity extends Activity implements AnyChatBaseEvent {
	// 视频配置界面标识
	...
	private void updateUserList() {
		...
		mAdapter = new RoleListAdapter(AnyChatMainActivity.this, mRoleInfoList);
		...
		mRoleList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == 0) {
					...
					intent.setClass(AnyChatMainActivity.this, VideoConfig.class);
	...
	private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals("VideoActivity")) {
				Toast.makeText(AnyChatMainActivity.this, "网络已断开！", Toast.LENGTH_SHORT)
						.show();
				setBtnVisible(SHOWLOGINSTATEFLAG);
				mRoleList.setAdapter(null);
				mBottomConnMsg.setText("No content to the server");
